...
export default function EditMenuItem() {
  ...
  const fetchMenuItem = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const item = menuItems.find((item: any) => item.id === parseInt(id!));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/vendor/menu-items/${id}`, {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Edit Menu Item</h1>
          <p className="text-muted-foreground">Update the details of your menu item</p>
        </div>
        ...
        <Card className="max-w-2xl mx-auto">
          <CardHeader className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-t-lg">
            ...
            <CardDescription className="text-orange-50">
              Update the details for your menu item
            </CardDescription>
          </CardHeader>
